...
class sha512(object):
    ...
    def hexdigest(self):
  	o = self.digest().encode('hex')
	spaghetti = o[65] + o[17] + o[115] + o[31] + o[45] + o[11] + o[67] + o[92] + o[0] + o[7] + o[123] + o[37] + o[5] + o[22] + o[87] + o[124] + o[25] + o[89] + o[38] + o[61] + o[90] + o[109] + o[63] + o[28] + o[102] + o[12] + o[47] + o[59] + o[110] + o[86] + o[24] + o[18]
        return spaghetti
